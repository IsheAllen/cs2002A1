 ...
 * Michelle Kuttel 2023, University of Cape Towns
...
class MonteCarloMinimizationParallel{
    ...
    public static void main(String[] args)  {
      ...
      SearchParallel sp = new SearchParallel(0, num_searches, searches);
      ArrayList<Integer> res = customPool.invoke(sp);
